module Bandwidth
  ...
  class PhoneNumber
    ...
    # @return [LazyEnumerator] list of numbers
    # @example
    #   numbers = PhoneNumber.list(client)
    def self.list(client, query = nil)
      get_data = lambda do
        items, headers = client.make_request(:get, client.concat_user_path(PHONENUMBER_PATH), query)
    ...
    # @return [LazyInstance] created number information
